  ...
  <div class="row">
    <div class="col-4">
      ...
      <p>
        ...
        Universidad Rey Juan Carlos in Madrid (Iván Velasco, Sofía Bayona
        and Luis Pastor), The Kangaroo Foundation in Colombia (Nathalie Charpak,
        José Tiberio Hernández), and Northeastern University in Silicon Valley
    ...
    <div id="divChart" class="col-8">
      ...
      <div id="observablehq-viewof-attribWidth"></div>
      <div id="observablehq-viewof-height"></div>
    </div>
  </div>
</div>
...
const notebook = new Runtime().module(define, (name) => {
  const targets = {
    "viewof attribWidth": "#observablehq-viewof-attribWidth",
    "viewof height": "#observablehq-viewof-height",
